...
namespace NET_02_Task01_01.Tests
{
    [TestFixture()]
    public class SortUsingStandardSortMethodTests
    {
        [TestCaseSource("TestArrays")]
        public void SortTests(int[,] sourceArray, int[,] resultsArray, SortCriteria sortBy)
        {
            // arrange
            var sortObject = new SortUsingStandardSortMethod();

            // act
            int[,] actual = sortObject.Sort(sourceArray, sortBy);
